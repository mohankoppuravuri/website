...
const Card = ({ src, title, date, subtitle }: {
    src: string;
    title: string;
    date: string;
    subtitle: string;
        ...
        <div class="mt-[80px] mb-[140px] items-center justify-center flex flex-col gap-[40px]">
            ...
            <div class="latest-updates-card-container">
                <div class="latest-updates-card-hiring">
                    ...
                    <button class="bg-text-white !text-orange-100 btn-white-lined  w-[158px] mt-auto">
                        Apply Now
                    </button>
                </div>
                <Card
                    ...
                    subtitle="Certified Agents"
                />
                <Card
                    src="images/british-council.png"
                    title="The British Council"
                    subtitle="Advanced Agent Certificate"
